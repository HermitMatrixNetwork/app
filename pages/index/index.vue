  ...
  <view class="index">
    ...
    <u-popup class="protocol" bgColor="#F7F8FA" :show="showProtocol" :round="16" mode="bottom" closeOnClickOverlay
      ...
      <view class="protocol-content">
        <text>
          由于越来越多的诈骗者想方设法欺骗毫无戒心的受害者的数字资产，请您在每次访问我们的域名站时验证SSL证书。本《服务协议》（定义如下）仅适用于由Encryption Everywhere DV TLS CA发布的具备有效SSL证书的域名站：https://xxxx.xx。在从您正在访问的网站下载、点击或以其他方式与之交互之前，请确保SSL证书的真实性。为免疑义，我们无法控制任何第三方网站或服务的内容、隐私政策或行为，也不对其承担任何责任。对于因使用或依赖任何此类网站或服务上或通过此类网站或服务提供的任何此类内容、商品或服务而造成或声称造成的任何损害或损失，我们概不负责或承担任何直接或间接责任。

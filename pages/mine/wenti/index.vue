  ...
  <view class="page-wrapper">
    ...
    <view class="content">
      ...
      <view class="wallet-name item">
        ...
        <!-- :class="{error: invalidFields.fieldName == 'name'}" -->
        <u-input
          class="wallet-name-input address"
          v-model="formData.email"
          :formatter="formatter"
          :placeholder="language.text71"
        >
        </u-input>
        <!-- :style="{ opacity: confirmePasswordError ? 1 : 0 }" -->
        <!--          <view class="error-tip">
      ...
      <SubmitBtn class="submit-btn" @click.native="submitBtn">{{
        language.text29
      }}</SubmitBtn>
    </view>
    ...
    >
      <template slot="default">
        <view>
          ...
          <u--input
            :placeholder="language.text99"
            border="surround"
            v-model="email"
            class="edit-name-input"
            :class="{ 'error-edit-name': editNameError }"
            clearable
			:formatter="formatter"
          >
          </u--input>
      ...
      <template slot="confirmButton">
        <view class="confirm-button">
          <uni-button class="cancel" @click="cancel()">{{
            language.text17
          }}</uni-button>
          <uni-button class="confirm" @click="confirm()">{{
            language.text29
          }}</uni-button>
...
.edit-name-modal {
  ...
  .confirm-button {
    ...
    /deep/ .cancel {
      ...
      border: 1px solid rgba(131, 151, 177, 0.3);

<template>
	<view class="mine">
		...
		<view class="import-container">
			...
			<view class="center">
				<view class="import-type" v-for="(item, index) in center" :key="item.name"
					@click="toPage('center', index)">
					<view class="content">
						<view class="content-icon">
							<image :src='`/static/img/mine/${ item.icon }`'></image>
						</view>
			...
			<view class="bottom">
				<view class="import-type" v-for="(item, index) in bottom" :key="item.name"
					@click="toPage('bottom', index)">
					<view class="content">
						<view class="content-icon">
							<image :src='`/static/img/mine/${ item.icon }`'></image>
						</view>
